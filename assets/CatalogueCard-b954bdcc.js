...
`,D=t.ul`
 ...
 `,B=t.p`
    ...
    margin-bottom: 4px;
    color: var(--text-black);
 `,de=({data:o,country:l,city:d})=>{if(!o)return;const{id:c,year:i,make:n,model:x,type:b,img:f,description:j,fuelConsumption:C,engineSize:v,accessories:p,functionalities:w,rentalPrice:y,mileage:g,rentalConditions:m}=o,r=m.split(`
`),u=parseInt(r[0].match(/\d+/));return e.jsxs(se,{children:[e.jsx(ae,{src:f,alt:n}),e.jsxs(le,{children:[n," ",e.jsx("span",{children:x}),", ",i," "]}),e.jsxs(D,{children:[e.jsxs(a,{children:[d,"  "]}),e.jsxs(a,{children:[l,"  "]}),e.jsxs(a,{children:["id: ",c,"  "]}),e.jsxs(a,{children:[i," "]}),e.jsxs(a,{children:["Type: ",b,"  "]})]}),e.jsxs(D,{children:[e.jsxs(a,{children:["Fuel Consumption: ",C," "]}),e.jsxs(a,{children:["Engine Size: ",v," "]})]}),e.jsx(ce,{children:j}),e.jsx(I,{children:"Accessories and functionalities:"}),e.jsx(B,{children:p.join(" | ")}),e.jsx(B,{children:w.join(" | ")}),e.jsx(I,{children:"Rental Conditions: "}),e.jsxs(z,{children:[e.jsxs(h,{children:["Minimum age : ",e.jsx("span",{children:u})]}),e.jsx(h,{children:r[1]})]}),e.jsxs(z,{children:[e.jsxs(h,{children:[r[2]," "]}),e.jsxs(h,{children:["Mileage: ",e.jsx("span",{children:g})]}),e.jsxs(h,{children:["Price: ",e.jsx("span",{children:y})]})]}),e.jsx(ie,{})]})},xe=document.querySelector("#modal-root"),pe=({closeModal:o,data:l,country:d,city:c})=>{const i=n=>{n.currentTarget===n.target&&o()};return E.useEffect(()=>{const n=x=>{x.key==="Escape"&&o()};return window.addEventListener("keydown",n),()=>{window.removeEventListener("keydown",n)}},[o]),A.createPortal(e.jsx(te,{onClick:i,children:e.jsxs(oe,{children:[e.jsx(ne,{onClick:o}),e.jsx(de,{data:l,country:d,city:c})]})}),xe)},ge=({advert:o})=>{const{id:l,year:d,make:c,model:i,type:n,img:x,functionalities:b,rentalPrice:f,rentalCompany:j,address:C,mileage:v}=o,[p,w]=E.useState(!1),g=P(G).some(T=>T.id===o.id),m=H(),r=C.split(" "),u=r[r.length-1],k=r[r.length-1-1],M=()=>{w(!p),p?document.body.style.overflow="hidden":document.body.style.overflow="auto"},F=()=>{console.log("ADDDDDD!!!"),m(Z(o))},R=()=>{console.log(l),console.log("Delete!!!"),m(q(l))};return e.jsxs(O,{children:[e.jsxs(U,{children:[e.jsx(V,{src:x,alt:c}),e.jsx(Y,{onClick:g?R:F,type:"button",children:g?e.jsx($,{}):e.jsx(_,{})})]}),e.jsxs(N,{children:[e.jsxs(X,{children:[c," ",e.jsx("span",{children:i}),", ",d]}),e.jsx("p",{children:f})]}),e.jsxs(ee,{children:[e.jsxs(L,{children:[e.jsxs(s,{children:[k," "]}),e.jsxs(s,{children:[u," "]}),e.jsxs(s,{children:[j,"  "]}),e.jsx(s,{children:n})]}),e.jsxs(L,{children:[e.jsxs(s,{children:[i," "]}),e.jsx(s,{children:v}),e.jsx(s,{children:b[0]})]})]}),e.jsx(Q,{type:"button",onClick:M,children:"Learn more"}),p&&e.jsx(pe,{closeModal:M,data:o,country:u,city:k})]})};export{ge as C};
